...
<section id="article" class="text-center p-5">
    ...
    <section id="gallery" class="text-center p-5 bg-success-subtle">
        <div class="container">
            <h1 class="fw-bold display-4 pb-3">Galeri Foto Ikonik Kota Solo</h1>
            
            <div id="galleryCarousel" class="carousel slide carousel-fade shadow-lg rounded" data-bs-ride="carousel">
                ...
                <div class="carousel-inner rounded">
                    <div class="carousel-item active">
                        <img src="image/Keraton Solo.jpeg" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Keraton Solo">
                    </div>
                    <div class="carousel-item">
                        <img src="image/Pasar Klewer.jpg" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Pasar Klewer">
                    </div>
                    <div class="carousel-item">
                        <img src="image/Tugu Pemandengan di depan Balai Kota Solo.jpg" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Tugu Pemandengan">
                    </div>
                    <div class="carousel-item">
                        <img src="image/Motif batik khas Solo yang elegan.jpg" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Batik Solo">
                    </div>
                    <div class="carousel-item">
                        <img src="image/masjid agung surakarta.jpg" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Masjid Agung Surakarta">
                    </div>
                    <div class="carousel-item">
                        <img src="image/Stadion Manahan Surakarta.jpeg" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Stadion Manahan">
                    </div>
                    <div class="carousel-item">
                        <img src="image/tugu laweyan.jpg" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Kampung Laweyan">
                    </div>
                    <div class="carousel-item">
                        <img src="image/Gerbang khas Pasar Gede Hardjonagoro.jpg" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Pasar Gede">
                    </div>
                    <div class="carousel-item">
                        <img src="image/Patung Skoekarno.jpg" class="d-block w-100" style="height: 500px; object-fit: cover;" alt="Patung Soekarno">
                    </div>
                </div>
